...
def test_sqlite_connection():
    """Tests connection to an in-memory SQLite database."""
    try:
        ...
        if result[0] == 1:
            print("SQLite in-memory database connection successful!")
        else:
            print("SQLite in-memory database connection failed.")
        conn.close()
